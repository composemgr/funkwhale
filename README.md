## 👋 Welcome to funkwhale 🚀

Self-hosted music server and social platform
...
- **funkwhale**: funkwhale/funkwhale:latest

### Infrastructure Components

- **funkwhale-db**: Postgres database
...
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/funkwhale/main/docker-compose.yaml" -o compose.yml
```
...
```shell
docker compose logs -f funkwhale
```
